                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$freq->freq}}</td>
                            <td>{{number_format($freq->support,4)*100}} %</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{(number_format($iteration['support'], 3)*100)}} %</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{(number_format($rule['support'], 3)*100)}}%</td>
                            <td>{{(number_format($rule['confidence'], 3)*100)}}%</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
